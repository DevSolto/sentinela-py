...
Gera um relatório CSV com os dados principais dos artigos e as cidades mencionadas em cada um. Caso um artigo cite múltiplas cidades, ele aparece uma vez por cidade; se não houver menção, o campo `cidade` fica vazio.
